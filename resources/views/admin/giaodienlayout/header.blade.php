...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Admin @if(Auth::check())
                 {{Auth::user()->name}}
                  @endif
             </a>
            </div>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                       @if(Auth::check())
                        <li>  <i class="fa fa-user fa-fw" style="margin-left: 17px"></i>{{Auth::user()->name}}</a>
                        </li>
           ...
           @include('admin.giaodienlayout.menu')
            <!-- /.navbar-static-side -->
        </nav>